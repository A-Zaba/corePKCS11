...
FetchContent_GetProperties(cmock POPULATED cmock_POPULATED)
...
macro(target_add_mock_pp mock_target cmock_config mock_header pp_args)
  ...
  add_custom_target(
    mocks_pp_dir ALL COMMAND ${CMAKE_COMMAND} -E make_directory
                             ${CMAKE_CURRENT_BINARY_DIR}/mocks_pp)
  ...
  add_custom_command(
    ...
    COMMAND ruby ${cmock_SOURCE_DIR}/lib/cmock.rb -o${cmock_config_absolute}
            ${CMAKE_CURRENT_BINARY_DIR}/mocks_pp/${mock_basename}.h
    WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}
    DEPENDS ${CMAKE_CURRENT_BINARY_DIR}/mocks_pp/${mock_basename}.h)

  target_sources(${mock_target}
                 PRIVATE ${CMAKE_CURRENT_BINARY_DIR}/mock_${mock_basename}.c)
