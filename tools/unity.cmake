...
FetchContent_GetProperties(unity POPULATED unity_POPULATED)
...
macro(target_add_test_runner target unity_config test_src)
  ...
  add_custom_command(
    ...
    COMMAND
      ruby ${unity_SOURCE_DIR}/auto/generate_test_runner.rb ${unity_config}
      ${test_src} ${CMAKE_CURRENT_BINARY_DIR}/${test_name}_runner.c
    WORKING_DIRECTORY ${CMAKE_CURRENT_LIST_DIR})
  target_sources(${target} ${s_flag}
