...
FetchContent_Declare(
  ...
  PATCH_COMMAND ${MODULE_ROOT_DIR}/tools/mbedtls_configure.sh <SOURCE_DIR>
                config.h)

FetchContent_GetProperties(mbedtls_2 POPULATED mbedtls_2_POPULATED)
...
if(NOT TARGET MbedTLS2_mbedtls)
  ...
  set_target_properties(
    ...
    PROPERTIES ARCHIVE_OUTPUT_DIRECTORY ${MBEDTLS_2_BIN_DIR}
               LIBRARY_OUTPUT_DIRECTORY ${MBEDTLS_2_BIN_DIR})
...
FetchContent_Declare(
  ...
  PATCH_COMMAND ${CMAKE_CURRENT_LIST_DIR}/mbedtls_configure.sh <SOURCE_DIR>
                mbedtls_config.h)

FetchContent_GetProperties(mbedtls_3 POPULATED mbedtls_3_POPULATED)
...
if(NOT TARGET MbedTLS3_mbedtls)
  ...
  set_target_properties(
    ...
    PROPERTIES ARCHIVE_OUTPUT_DIRECTORY ${MBEDTLS_3_BIN_DIR}
               LIBRARY_OUTPUT_DIRECTORY ${MBEDTLS_3_BIN_DIR})
