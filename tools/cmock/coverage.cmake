...
# set(BINARY_DIR ${CMAKE_BINARY_DIR}) reset coverage counters
execute_process(
...
execute_process(
  COMMAND ruby ${CMAKE_BINARY_DIR}/_deps/unity-src/auto/parse_output.rb -xml
...
execute_process(
  COMMAND
    ...
    --output-file ${CMAKE_BINARY_DIR}/second_coverage.info --quiet)
...
execute_process(
  COMMAND
    lcov --remove ${CMAKE_BINARY_DIR}/coverage.info \*_deps\* --output-file
    ${CMAKE_BINARY_DIR}/coverage.info --rc lcov_branch_coverage=1 --quiet)

execute_process(COMMAND lcov --list ${CMAKE_BINARY_DIR}/coverage.info --rc
